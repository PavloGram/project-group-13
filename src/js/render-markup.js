...
//     .map(film => {
//       if (film.genre_ids.length < 2 && film.genre_ids.length !==0 && film.genre_ids.length ==='') {
//         const cardFilm = `
//       <div class="film-card" data-id=${film.id}>
//         <img class="film-poster" 
//         src="${film.poster_path === null ? `${notPic}`: `https://image.tmdb.org/t/p/w500${film.poster_path}`
//       }"
//         alt=${film.title}>
